...
namespace Quan_Ly_Sinh_Vien.Controllers
{
    public class LopHocController : Controller
    {
        ...
        public LopHocController(QuanLySinhVienContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaLop,TenLop,SiSo,TenGiangVien,PhongHoc,NamHoc,KhoaHoc,GioiTinhGiangVien")] LopHoc lopHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLop,TenLop,SiSo,TenGiangVien,PhongHoc,NamHoc,KhoaHoc,GioiTinhGiangVien")] LopHoc lopHoc)
        {
            if (id != lopHoc.MaLop)
            {
                return NotFound();
